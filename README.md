...
[Dashboard](https://pegasusbot.app) · [Developer](https://semiconstructor.com) · [Report a Bug](https://github.com/semi-constructor/pegasus-dashboard/issues)
...
- **[Management] Dynamic Module Management**: Configure and toggle core bot modules on the fly, including:
  ...
  - **Birthdays**: Automatically announce member birthdays with customizable messages and channels.
  - **Social Feeds**: Sync and post YouTube and RSS feed updates automatically to Discord channels.
- **[Public] Public Leaderboards**: Enable and showcase public, read-only leaderboards for Server XP, Economy, and Giveaways directly on the dashboard.
...
### 🚀 Interactive One-Command Install (Recommended)

Deploy the Dashboard, the Pegasus Bot, or the complete stack effortlessly using our universal interactive installer script. The script automatically handles repository cloning, prompts you through configuring your `.env` variables, and spins everything up using Docker (or PM2).
