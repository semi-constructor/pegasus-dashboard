...
import { CheckCircle2, XCircle, LayoutDashboard, History, Wallet } from 'lucide-react';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: '/alternatives/dyno',
    },
    openGraph: {
      title: t('metaTitle'),
      description: t('metaDescription'),
      url: `${baseUrl}/alternatives/dyno`,
    },
  };
}
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-zinc-800 bg-zinc-800/20">
                  ...
                  <th className="p-6 text-zinc-400 font-medium text-center w-1/3">Dyno</th>
