      ...
      <MarketingLayout>
        <div className="min-h-screen bg-black flex items-center justify-center selection:bg-white selection:text-black">
          <div className="text-center p-12 border border-white/10 bg-[#050505] max-w-md">
            ...
            <h2 className="text-sm font-medium text-white uppercase tracking-[0.2em] mb-2">Private Economy</h2>
            <p className="text-white/40 text-xs uppercase tracking-[0.2em]">This server has not enabled its public economy leaderboard.</p>
          </div>
        </div>
      </MarketingLayout>
    );
          ...
          <div className="border border-white/10 bg-[#050505]">
            {topUsers.length === 0 ? (
              <div className="text-center py-24">
                ...
                <h3 className="text-sm font-medium text-white/50 uppercase tracking-[0.2em] mb-2">No Wealthy Members Yet</h3>
                <p className="text-white/30 text-xs uppercase tracking-[0.2em]">Nobody has started their economic journey in this server.</p>
              </div>
            ) : (
