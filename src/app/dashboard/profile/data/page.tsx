...
export default async function PersonalDataPage() {
 ...
 You do not have permission to access the Data Export utility. This feature is restricted to system administrators.
 </p>
 </div>
 );
 }
 ...
 <div>
 <h1 className="text-3xl font-bold text-foreground tracking-tight">Data Export</h1>
 <p className="text-muted-foreground mt-2">Export your personal data from the database.</p>
 </div>

 <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 flex gap-4">
 <Info className="w-6 h-6 text-primary flex-shrink-0"/>
 <div>
 <h3 className="text-primary font-semibold mb-1">Privacy Guarantee</h3>
 <p className="text-sm text-foreground/80">
 This tool strictly aggregates rows where the <code>discord_id</code> matches your authenticated session.
 It ensures that you can review your footprint without exposing other users' data.
 </p>
 </div>
 </div>
 ...
 <h3 className="text-lg font-bold text-foreground mb-2">Export Full Archive (ZIP)</h3>
 <p className="text-sm text-muted-foreground mb-6">
 Downloads a compressed ZIP containing JSON files for every database table where your user ID appears.
 </p>
 ...
 <h3 className="text-lg font-bold text-foreground mb-2">Export Raw Data (JSON)</h3>
 <p className="text-sm text-muted-foreground mb-6">
 Downloads a single JSON file containing all your records structured by table name.
 </p>
