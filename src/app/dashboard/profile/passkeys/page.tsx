...
export default async function PasskeyManagementPage() {
  ...
  if (!isAdmin) {
    return (
      <div className="max-w-4xl mx-auto p-6">
        ...
        <p className="text-muted-foreground mt-2">Only system administrators can access passkeys.</p>
      </div>
    );
  }
 ...
 <div>
 <h2 className="text-2xl font-bold tracking-tight">Passkey Management</h2>
 <p className="text-muted-foreground">Manage your hardware keys and biometrics for secure login.</p>
 </div>
 ...
 <div>
 <h3 className="font-medium text-orange-200">Passkey Required</h3>
 <p className="text-sm text-orange-200/70 mt-1">
 You must register at least one passkey to access the admin dashboard securely.
 </p>
 </div>
 </div>
 )}
