    ...
    <div className="relative overflow-hidden pb-16">
      ...
      <div className="container mx-auto px-2 relative z-10 max-w-4xl pt-8">
        <div className="mb-10">
          ...
          <div className="mb-4 inline-block px-3 py-1 bg-yellow-500/20 text-yellow-500 border border-yellow-500/30 rounded-full text-xs font-bold uppercase tracking-wider">
            Live Preview
          </div>
