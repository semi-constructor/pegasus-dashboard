...
export default function GiveawaysClient({
 ...
 <FormSection title="Create Giveaway"icon={Gift} description="Launch a new contest.">
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-1">
 <label className="text-xs font-bold uppercase">Prize Name</label>
 <Input
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold uppercase">Announcement Channel</label>
 <DiscordChannelPicker
 channels={channels}
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold uppercase">Winner Count</label>
 <Input
 type="number"
 min={1}
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold uppercase">Duration (Hours)</label>
 <Input
 type="number"
 min={1}
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-1">
 <label className="text-xs font-bold uppercase">Required Roles to Enter</label>
 <DiscordRoleMultiPicker
 roles={roles}
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold uppercase">Minimum Member Level Required</label>
 <Input
 type="number"
 min={0}
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-1">
 <label className="text-xs font-bold uppercase">Bonus Multiplier Role</label>
 <DiscordRolePicker
 roles={roles}
 ...
 <div className="space-y-1">
 <label className="text-xs font-bold uppercase">Extra Entries Granted</label>
 <Input
 type="number"
 min={1}
 ...
 >
 <Plus className="w-4 h-4 mr-2"/>Start Giveaway</Button>
 </FormSection>

 {/* Giveaways List */}
 <FormSection title="Guild Giveaways"icon={Gift} description="Active and past giveaways.">
