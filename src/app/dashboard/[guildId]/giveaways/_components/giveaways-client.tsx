      ...
      <div className="grid gap-4 py-4 max-h-[70vh] overflow-y-auto pr-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-2">
            <label className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2 ml-1">Prize Name</label>
            <Input
          ...
          <div className="flex flex-col gap-2">
            <label className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2 ml-1">Winner Count</label>
            <Input
              type="number"
              min={1}
          ...
          <div className="flex flex-col gap-2">
            <label className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2 ml-1">Duration (Hours)</label>
            <Input
              type="number"
              min={1}
          ...
          <div className="flex flex-col gap-2">
            <label className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2 ml-1">Schedule Start Time (Local Time)</label>
            <Input
              type="datetime-local"
              value={newGw.scheduledStartTime || ""}
              onChange={(e) => setNewGw({ ...newGw, scheduledStartTime: e.target.value || null })}
              className="w-full bg-white/5 border border-white/10 text-white placeholder:text-white/30 rounded-lg min-h-[40px] px-3 py-2 focus-visible:ring-1 focus-visible:ring-primary/50 transition-all [color-scheme:dark]"
            />
          </div>
        </div>
        ...
        <div className="p-4 border border-white/10 bg-white/5 rounded-lg space-y-4 mt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <label className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2 ml-1">Required Roles to Enter</label>
              <DiscordRoleMultiPicker
                roles={roles}
            ...
            <div className="flex flex-col gap-2">
              <label className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2 ml-1">Minimum Member Level Required</label>
              <Input
                type="number"
                min={0}
        ...
        <div className="p-4 border border-white/10 bg-white/5 rounded-lg space-y-4 mt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <label className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2 ml-1">Bonus Multiplier Role</label>
              <DiscordRolePicker
                roles={roles}
            ...
            <div className="flex flex-col gap-2">
              <label className="block text-xs font-bold text-white/70 uppercase tracking-wider mb-2 ml-1">Extra Entries Granted</label>
              <Input
                type="number"
                min={1}
