...
export default function EngagementClient({
  ...
  return (
    <div className="p-6 md:p-10 relative flex-1 overflow-hidden animate-in fade-in duration-500 max-w-[1600px] mx-auto w-full">
      ...
      <div className="bg-foreground/5 border border-border rounded-2xl shadow-2xl relative overflow-hidden min-h-[600px] flex flex-col backdrop-blur-md">
        ...
        <div className="flex overflow-x-auto items-end bg-background/40 pt-4 px-4 border-b border-border [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {tabs.map((tab) => (
            <button
              key={tab.id}
            ...
            >
              <tab.icon className={cn("w-4 h-4 transition-colors", activeTab === tab.id ? "text-foreground" : "text-foreground/40 group-hover:text-foreground/60")} />
              {tab.label}
  ...
  <Dialog open={isAchDialogOpen} onOpenChange={setIsAchDialogOpen}>
   <DialogContent className="bg-background/90 border border-border text-foreground backdrop-blur-xl sm:max-w-[700px]">
    ...
    <div className="grid gap-4 py-4 max-h-[70vh] overflow-y-auto pr-2">
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Achievement ID</label>
       <Input
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Title</label>
       <Input
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Requirement Type</label>
       <select
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Requirement Target Value</label>
       <Input
        type="number"
        min={1}
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Reward XP (Optional)</label>
       <Input
        type="number"
        min={0}
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Reward Coins (Optional)</label>
       <Input
        type="number"
        min={0}
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Requirement Channel (Optional)</label>
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Notification Channel (Optional)</label>
       <DiscordChannelPicker
        channels={channels}
    ...
    <div className="flex justify-end gap-2 border-t border-border pt-4">
     <Button variant="ghost" onClick={() => { setIsAchDialogOpen(false); setEditingAchId(null); setNewAch({ achievementId: "", title: "", description: "", requirementType: "messages_sent", requirementValue: 100, rewardXp: 500, rewardCoins: 100, channelId: "", requirementChannelId: "" }); }} className="text-foreground/50 hover:text-foreground">
      Cancel
     </Button>
     <Button onClick={handleCreateAchievement} disabled={isPending} className="bg-foreground/10 hover:bg-foreground/20 text-foreground border-0">
 ...
 <div
 key={a.id}
 className="p-4 rounded-xl border border-border bg-background/20 text-foreground backdrop-blur-md hover:bg-foreground/5 transition-all flex justify-between items-center shadow-sm"
 >
 <div>
 <div className="flex items-center gap-2">
 <span className="font-bold text-foreground/80 uppercase tracking-wider">{a.title}</span>
 ...
 [{a.achievementId}]
  ...
  {a.requirementChannelId && (
    <span className="text-xs uppercase bg-foreground/20 text-foreground px-2 py-0.5 rounded font-bold border border-border/30 ml-2">
 ...
 Req: {a.requirementType} &ge; {a.requirementValue} | Reward: {a.rewardXp} XP + {a.rewardCoins} Coins
  ...
  <Button
  size="sm"
  className="bg-foreground/5 hover:bg-foreground/10 text-foreground border border-border"
  onClick={() => {
  ...
  <Dialog open={isQuestDialogOpen} onOpenChange={setIsQuestDialogOpen}>
   <DialogContent className="bg-background/90 border border-border text-foreground backdrop-blur-xl sm:max-w-[700px]">
    ...
    <div className="grid gap-4 py-4 max-h-[70vh] overflow-y-auto pr-2">
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Quest ID</label>
       <Input
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Quest Title</label>
       <Input
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Quest Type</label>
       <select
        value={newQuest.type}
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Active Duration (Days)</label>
       <Input
        type="number"
        min={1}
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Target Value</label>
       <Input
        type="number"
        min={1}
    ...
    <div className="flex justify-end gap-2 border-t border-border pt-4">
     <Button variant="ghost" onClick={() => setIsQuestDialogOpen(false)} className="text-foreground/50 hover:text-foreground">
      Cancel
     </Button>
     <Button onClick={handleCreateQuest} disabled={isPending} className="bg-foreground/10 hover:bg-foreground/20 text-foreground border-0">
  ...
  <Dialog open={isFeedDialogOpen} onOpenChange={setIsFeedDialogOpen}>
   <DialogContent className="bg-background/90 border border-border text-foreground backdrop-blur-xl sm:max-w-[700px]">
    ...
    <div className="grid gap-4 py-4 max-h-[70vh] overflow-y-auto pr-2">
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Feed Type</label>
       <select
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Custom Message</label>
       <Textarea
      ...
      {newFeed.feedType === "youtube" && (
       <div className="flex flex-col gap-2 md:col-span-2">
        <div className="flex items-center gap-2 mt-2">
         ...
         />
         <label className="text-sm font-bold text-foreground">Longform Videos Only (No Shorts)</label>
        </div>
       </div>
      )}
     </div>
    ...
    <div className="flex justify-end gap-2 border-t border-border pt-4">
     <Button variant="ghost" onClick={() => { setIsFeedDialogOpen(false); setEditingFeedId(null); }} className="text-foreground/50 hover:text-foreground">
      Cancel
     </Button>
     <Button onClick={handleCreateFeed} disabled={isPending} className="bg-foreground/10 hover:bg-foreground/20 text-foreground border-0">
 ...
 <tr>
 <td colSpan={4} className="p-6 text-center text-foreground/40 uppercase">
  ...
  <FormSection title="Birthday Settings" icon={Target} description="Announce member birthdays automatically.">
   <div className="space-y-6">
    <div className="flex items-center gap-2">
     ...
     <label className="text-sm font-bold text-foreground">Enable Birthday Announcements</label>
    </div>
    {birthdaySettings.enabled && (
     <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2">
       <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">Announcement Message</label>
       <Textarea
    ...
    <Button onClick={handleSaveBirthdays} disabled={isPending} className="bg-foreground/10 hover:bg-foreground/20 text-foreground border-0">
  ...
  >
   <div className="space-y-3">
    {initialFeeds.length === 0 ? (
     ...
     initialFeeds.map((f) => (
      <div key={f.id} className="p-4 rounded-xl border border-border bg-background/20 text-foreground backdrop-blur-md hover:bg-foreground/5 transition-all flex justify-between items-center shadow-sm">
       <div>
        <div className="flex items-center gap-2">
         <span className="font-bold uppercase text-primary">{f.feedType}</span>
         <span className="text-xs uppercase bg-foreground/20 text-foreground px-2 py-0.5 rounded font-bold border border-border/30">
          Notifies # {f.channelId}
         </span>
        </div>
        <p className="text-xs text-foreground/40 mt-1 truncate max-w-xs">{f.feedUrl}</p>
       </div>
       <div className="flex items-center gap-2">
        <Button size="sm" className="bg-foreground/5 hover:bg-foreground/10 text-foreground border border-border" onClick={() => {
