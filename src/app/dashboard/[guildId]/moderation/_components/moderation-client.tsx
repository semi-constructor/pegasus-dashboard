...
"tickets",
 ...
 enabled: setting.enabled,
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* Navigation Tabs */}
      <div className="flex flex-wrap bg-background/40 p-1 rounded-lg w-fit border border-border gap-1">
        {[
 ...
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('issueWarning.userId')}</label>
 <DiscordUserPicker
  guildId={guildId}
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('issueWarning.warnTitle')}</label>
 <Input
 ...
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('issueWarning.desc')}</label>
 <Textarea
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('issueWarning.level')}</label>
 <Input
 type="number"
 min={1}
 max={5}
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('issueWarning.proof')}</label>
 <Input
 ...
 initialWarnings.map((w) => (
                  <div
                    key={w.id}
                    className="p-4 rounded-xl border border-border bg-foreground/5 flex flex-col gap-3 shadow-lg"
                  >
 <div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createAuto.name')}</label>
 <Input
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createAuto.triggerType')}</label>
 <select
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createAuto.triggerValue')}</label>
 <Input
 type="number"
 min={1}
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createAuto.action')}</label>
 <select
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createAuto.notify')}</label>
 <DiscordChannelPicker
 channels={channels}
 ...
 initialAutomations.map((a) => (
                <div
                  key={a.id}
                  className="p-4 rounded-xl border border-border bg-foreground/5 flex items-start gap-4 shadow-lg"
                >
 <div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createFilter.pattern')}</label>
 <Input
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createFilter.matchType')}</label>
 <select
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createFilter.severity')}</label>
 <select
 ...
 <div className="flex flex-col gap-2">
 <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('createFilter.notify')}</label>
 <DiscordChannelPicker
 channels={channels}
 ...
 initialWordFilters.map((f) => (
                <div
                  key={f.id}
                  className="p-4 rounded-xl border border-border bg-foreground/5 flex justify-between items-center shadow-lg"
                >
 <div>
 <div className="flex items-center gap-2">
 ...
 return (
 <div key={cat} className="p-4 rounded-xl border border-border bg-background/20 space-y-3 shadow-lg">
 <div className="flex items-center justify-between">
 <span className="font-bold text-foreground/80 uppercase tracking-wider text-sm">{cat}_LOGS</span>
 <ToggleField
 label=""
