 ...
 const handleCreateAuto = () => {
  ...
  return (
    <div className="text-foreground p-6 lg:p-10 max-w-[1400px] mx-auto animate-in fade-in duration-500">
      ...
      {/* Navigation Tabs */}
      <div className="flex flex-wrap gap-2 mb-8 bg-background/20 p-1.5 rounded-xl border border-border w-fit">
        {[
   ...
   <Dialog open={isWarnDialogOpen} onOpenChange={setIsWarnDialogOpen}>
    <DialogContent className="bg-background/90 border border-border text-foreground backdrop-blur-xl sm:max-w-[700px]">
     ...
     <div className="grid gap-4 py-4 pr-2">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.userId')}</label>
        <DiscordUserPicker
         guildId={guildId}
       ...
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.warnTitle')}</label>
        <Input
       ...
       <div className="space-y-1 md:col-span-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.description')}</label>
        <Textarea
       ...
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.level')}</label>
        <Input
         type="number"
         min={1}
         max={100}
       ...
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.proof')}</label>
        <Input
     ...
     <div className="flex justify-end gap-2 border-t border-border pt-4">
      <Button variant="ghost" onClick={() => setIsWarnDialogOpen(false)} className="text-foreground/50 hover:text-foreground">{t('dialog.cancel')}</Button>
      <Button onClick={handleCreateWarn} disabled={isPending} className="bg-foreground/10 hover:bg-foreground/20 text-foreground border-0">
   ...
   <Dialog open={isAutoDialogOpen} onOpenChange={setIsAutoDialogOpen}>
    <DialogContent className="bg-background/90 border border-border text-foreground backdrop-blur-xl sm:max-w-[700px]">
     ...
     <div className="grid gap-4 py-4 pr-2 max-h-[70vh] overflow-y-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.autoName')}</label>
        <Input
       ...
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.triggerMetric')}</label>
        <select
       ...
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.threshold')}</label>
        <Input
         type="number"
         min={1}
       ...
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.actionToExecute')}</label>
        <select
       ...
       {newAuto.actionType === "timeout" && (
        <div className="flex flex-col gap-2">
         <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.timeoutDuration')}</label>
         <Input
          type="number"
          min={60}
      ...
      <div className="p-4 border border-border bg-foreground/5 rounded-lg space-y-4 mt-2">
       ...
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.notifyChannel')}</label>
        <DiscordChannelPicker
         channels={channels}
       ...
       <div className="flex flex-col gap-2">
        <label className="block text-xs font-bold text-foreground/70 uppercase tracking-wider mb-2 ml-1">{t('dialog.notifyMessage')}</label>
        <Textarea
     ...
     <div className="flex justify-end gap-2 border-t border-border pt-4">
      <Button variant="ghost" onClick={() => setIsAutoDialogOpen(false)} className="text-foreground/50 hover:text-foreground">{t('dialog.cancel')}</Button>
      <Button onClick={handleCreateAuto} disabled={isPending} className="bg-foreground/10 hover:bg-foreground/20 text-foreground border-0">
        ...
        >
         <div>
          <div className="flex items-center gap-2">
           ...
           <span className="font-bold text-foreground/80 uppercase tracking-wider">{t('warningsList.user', { id: warn.userId })}</span>
           {!warn.active && (
          ...
          <p className="text-xs text-foreground/40 mt-1">{t('warningsList.level', { level: warn.level })} | {warn.description}</p>
         </div>
        ...
        >
         <div>
          <div className="flex items-center gap-2">
           ...
           <span className="font-bold text-foreground/80 uppercase tracking-wider">{auto.name}</span>
