      ...
      <MarketingLayout>
        <div className="min-h-screen bg-background flex items-center justify-center selection:bg-foreground selection:text-background">
          <div className="text-center p-12 border border-border bg-[#050505] max-w-md">
            ...
            <h2 className="text-sm font-medium text-foreground uppercase tracking-[0.2em] mb-2">Private Leaderboard</h2>
            <p className="text-foreground/40 text-xs uppercase tracking-[0.2em]">This server has not enabled its public XP leaderboard.</p>
          </div>
        </div>
      </MarketingLayout>
    );
          ...
          <div className="border border-border bg-[#050505]">
            {topUsers.length === 0 ? (
              <div className="text-center py-24">
                ...
                <h3 className="text-sm font-medium text-foreground/50 uppercase tracking-[0.2em] mb-2">No Active Members Yet</h3>
                <p className="text-foreground/30 text-xs uppercase tracking-[0.2em]">Nobody has gained XP in this server.</p>
              </div>
            ) : (
                ...
                {topUsers.map((user, index) => (
                  ...
                  >
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      <div className="text-[10px] text-foreground/20 uppercase tracking-[0.3em]">
