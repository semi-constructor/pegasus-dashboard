      ...
      <div className="relative min-h-screen bg-background pt-48 pb-32 overflow-hidden selection:bg-foreground selection:text-background">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-24 relative z-10">
          ...
          <section className="mb-32">
            ...
            <div className="pl-6 md:pl-12 space-y-px bg-foreground/10">
              {[
                ...
                <div key={item.cmd} className="flex items-center gap-6 bg-[#050505] p-4">
                  <code className="text-foreground font-mono text-xs uppercase tracking-[0.3em] min-w-[120px]">{item.cmd}</code>
                  <span className="text-foreground/40 text-sm font-light">{item.desc}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <Link href="/docs/commands" className="group inline-flex items-center px-8 py-4 bg-foreground text-background text-xs font-bold tracking-[0.3em] uppercase hover:bg-zinc-200 transition-colors">
