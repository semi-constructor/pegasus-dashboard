          ...
          <section className="mb-32">
            ...
            <div className="pl-6 md:pl-12 space-y-8">
              {[
                ...
                <div key={item.step} className="border border-border bg-[#050505] p-8 flex items-start gap-6">
                  <span className="text-3xl font-medium tracking-tighter text-foreground/20 font-mono flex-shrink-0">{item.step}</span>
                  <div>
                    <h3 className="text-foreground font-medium text-sm uppercase tracking-[0.2em] mb-3">{item.title}</h3>
