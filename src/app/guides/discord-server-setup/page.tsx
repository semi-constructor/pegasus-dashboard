    ...
    <MarketingLayout>
      ...
      <div className="relative min-h-screen bg-background pt-48 pb-32 overflow-hidden selection:bg-foreground selection:text-background">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-24 relative z-10">
          ...
          {/* Table of Contents */}
          <div className="border border-border bg-[#050505] p-8 mb-24">
            <h2 className="text-sm font-medium text-foreground uppercase tracking-[0.3em] mb-6">Table of Contents</h2>
            <div className="space-y-3">
              {[
                ...
                <a key={item.id} href={`#${item.id}`} className="flex items-center gap-3 text-foreground/40 hover:text-foreground text-sm transition-colors group">
          ...
          <section id="step-1" className="mb-24">
            <div className="flex items-center gap-4 mb-8">
              <Settings className="w-6 h-6 text-foreground/30" />
              <h2 className="text-2xl font-medium text-foreground uppercase tracking-[0.2em]">Step 1: Categories & Channels</h2>
            </div>
            <div className="pl-10 space-y-4 text-foreground/40 text-sm font-light leading-relaxed">
              ...
              <div className="border border-border bg-[#050505] p-6 space-y-3">
                {[
                  ...
                  <div key={c.title} className="flex items-start gap-3">
                    ...
                    <div><strong className="text-foreground text-xs uppercase tracking-[0.2em]">{c.title}:</strong> <span className="text-foreground/40 font-mono text-xs">{c.desc}</span></div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section id="step-2" className="mb-24">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl font-medium text-foreground uppercase tracking-[0.2em]">Step 2: Roles and Permissions</h2>
            </div>
            <div className="pl-10 space-y-4 text-foreground/40 text-sm font-light leading-relaxed">
              <p>Discord&apos;s permission hierarchy can be confusing. The golden rule is: <strong className="text-foreground">never give standard members the Administrator permission</strong>.</p>
              <p>Create a hierarchical role structure: Owner → Admin → Moderator → Verified Member → @everyone. Use <Link href="/features/moderation" className="text-foreground underline underline-offset-4 hover:text-foreground/80 transition-colors">PegasusBot&apos;s Reaction Roles</Link> to allow users to self-assign cosmetic roles safely.</p>
            </div>
          </section>
          ...
          <section id="step-3" className="mb-24">
            <div className="flex items-center gap-4 mb-8">
              <ShieldCheck className="w-6 h-6 text-foreground/30" />
              <h2 className="text-2xl font-medium text-foreground uppercase tracking-[0.2em]">Step 3: Securing with PegasusBot</h2>
            </div>
            <div className="pl-10 space-y-4 text-foreground/40 text-sm font-light leading-relaxed">
              <p>As soon as your server goes public, it becomes a target for spam bots and raiders. You must set up Automod immediately.</p>
              <div className="border border-border bg-[#050505] p-6">
                <h4 className="text-foreground text-xs uppercase tracking-[0.3em] mb-3">// PRO_TIP: ENABLE ANTI-RAID</h4>
                <p className="text-foreground/40 text-sm font-light">Log into the PegasusBot dashboard, navigate to the Automod section, and enable <strong className="text-foreground">Anti-Raid</strong>. This will automatically lock the server if too many accounts join simultaneously.</p>
              </div>
            </div>
          </section>
          ...
          <section id="step-4" className="mb-32">
            <h2 className="text-2xl font-medium text-foreground uppercase tracking-[0.2em] mb-8 pl-10">Step 4: Welcome Messages</h2>
            <div className="pl-10 text-foreground/40 text-sm font-light leading-relaxed">
          ...
          <div className="border border-border bg-[#050505] p-12 text-center">
            <h3 className="text-2xl font-medium text-foreground mb-6 uppercase tracking-[0.2em]">Ready to launch your server?</h3>
            <p className="text-foreground/40 text-sm font-light mb-8">Add PegasusBot now to get all the tools you need in one place.</p>
