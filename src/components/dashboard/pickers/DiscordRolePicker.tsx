...
export function DiscordRolePicker({
 ...
 const defaultPlaceholder = placeholder || t('pickers.selectRole');
 ...
 <Command>
 <CommandInput placeholder={t('pickers.searchRoles')}/>
 <CommandList>
 <CommandEmpty>{t('pickers.noRolesFound')}</CommandEmpty>
 <CommandGroup>
 {value && (
 <CommandItem
 onSelect={() => {
...
export function DiscordRoleMultiPicker({
 ...
 const t = useTranslations('forms');
 const defaultPlaceholder = placeholder || t('pickers.selectRoles');
 const [open, setOpen] = React.useState(false);
